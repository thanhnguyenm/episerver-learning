...
{
    [ServiceConfiguration(ServiceType = typeof(IPageViewContextFactory), Lifecycle = ServiceInstanceScope.HttpContext)]
    public class PageViewContextFactory : IPageViewContextFactory
    {
        ...
        public virtual LayoutViewModel CreateLayoutModel(ContentReference currentContentLink, RequestContext requestContext)
        {
