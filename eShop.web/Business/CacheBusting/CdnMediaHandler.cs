...
using eShop.web.Business.Initialization;
using System;
using System.Configuration;
using System.Web;

namespace eShop.web.Business.CacheBusting
{
    ...
    public class CdnMediaHandler : BlobHttpHandler, IRenderTemplate<IContentMedia>
    {
        ...
        protected override void SetCachePolicy(System.Web.HttpContextBase context, DateTime fileChangedDate)
        {
            ...
            {
                var cdnString = (string)context.Items[CdnModuleInitialization.CdnRequest];
                var expectedString = CdnModuleInitialization.Unique(helper.Content);
        ...
        {
            return !ctx.Request.IsAuthenticated && ctx.Items[CdnModuleInitialization.CdnRequest] != null;
        }
    }
}