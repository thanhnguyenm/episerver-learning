...
namespace eShop.web.Helpers
{
    public static class HtmlHelpers
    {
        ...
        public static IHtmlString MenuList(
            ...
            Func<MenuItemModel, HelperResult> itemTemplate = null,
        ...
        private static MenuItemModel CreateMenuItem(PageData page, ContentReference currentContentLink, List<ContentReference> pagePath, IContentLoader contentLoader, Func<IEnumerable<PageData>, IEnumerable<PageData>> filter)
        {
            var menuItem = new MenuItemModel(page)
            {
        ...
        private static Func<MenuItemModel, HelperResult> GetDefaultItemTemplate(HtmlHelper helper)
        {
